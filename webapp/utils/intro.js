...
(function(root, factory) {
	...
	function IntroJs(obj) {
		...
		this._options = {
			...
			nextLabel: 'Sonraki &rarr;',
			/* Previous button label in tooltip box */
			prevLabel: '&larr; Önceki',
	...
	function _nextStep() {
		...
		if (typeof(this._introBeforeChangeCallback) !== 'undefined') {
			...
			/*if (continueStep[0].getSections()[this._currentStep]) {
				continueStep[0].setSelectedSection(continueStep[0].getSections()[this._currentStep].getId());
			}*/
		}

		// if `onbeforechange` returned `false`, stop displaying the element
		if (continueStep[1] === false) {
			--this._currentStep;
			return false;
		}
	...
	function _showElement(targetElement) {
		...
		if (oldHelperLayer != null) {
			...
			if (oldHelperNumberLayer != null) {
				...
				if (lastIntroItem != null && (this._direction == 'forward' && lastIntroItem.position == 'floating') || (this._direction == 'backward' &&
	...
	function _setShowElement(targetElement) {
		...
		while (parentElm != null) {
			...
			var transform = _getPropValue(parentElm, 'transform') || _getPropValue(parentElm, '-webkit-transform') || _getPropValue(parentElm,
				'-moz-transform') || _getPropValue(parentElm, '-ms-transform') || _getPropValue(parentElm, '-o-transform');
	...
	function _addOverlayLayer(targetElm) {
		...
		if (!targetElm.tagName || targetElm.tagName.toLowerCase() === 'body') {
			...
			if (elementPosition) {
				styleText += 'width: ' + elementPosition.width + 'px; height:' + elementPosition.height + 'px; top:' + elementPosition.top +
