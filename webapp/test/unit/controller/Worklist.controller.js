sap.ui.define(
  [
    "hcm/ux/hapv2.1/controller/Worklist.controller",
  ...
  function (WorklistController, BaseController, ManagedObject, FakeI18n) {
    ...
    QUnit.module("Table busy indicator delay", {
      beforeEach: function () {
        ...
        sinon
          .stub(this.oWorklistController, "getOwnerComponent")
    ...
    QUnit.test(
      "Should set the initial busyindicator delay to 0",
      function (assert) {
        // Act
        ...
        // Assert
        assert.strictEqual(
          this.oWorklistController.getModel("worklistView").getData()
            .tableBusyDelay,
          0,
    ...
    QUnit.test(
      "Should reset the busy indicator to the original one after the first request completed",
      function (assert) {
        // Arrange
