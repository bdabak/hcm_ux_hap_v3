sap.ui.define(
  [
    ...
    "hcm/ux/hapv3/test/integration/pages/shareOptions",
  ],
  function (
    Opa5,
    Press,
    ...
    function allItemsInTheListContainTheSearchTerm(aControls) {
      ...
      return aItems.every(function (oItem) {
        return (
          oItem.getCells()[0].getTitle().indexOf(oSearchField.getValue()) !== -1
        );
      });
    }
    ...
    function createWaitForItemAtPosition(oOptions) {
      ...
      return {
        ...
        errorMessage:
          "Table in view '" +
          sViewName +
          "' does not contain an Item at position '" +
          iPosition +
          "'",
      };
    }
        ...
        actions: jQuery.extend(
          {
                ...
                createWaitForItemAtPosition({
                  ...
                  success: function (oTableItem) {
                    ...
                    this.getContext().currentItem = {
                      ...
                      id: oBindingContext.getProperty("AppraisalId"),
                      name: oBindingContext.getProperty("AppraisalName"),
                    };
                  },
                })
              );
              ...
              return this.waitFor({
                ...
                success: function (oTable) {
                  ...
                  this.waitFor({
                    ...
                    errorMessage:
                      "Did not find any table entries or too many while trying to search for the first object.",
                  });
                },
                errorMessage:
                  "Did not find table entries while trying to search for the first object.",
              });
            },
            ...
            iSearchForValue: function (sSearchString) {
              return this.iSearchForValueWithActions([
                new EnterText({ text: sSearchString }),
                new Press(),
              ]);
            },
            ...
            iTypeSomethingInTheSearchThatCannotBeFoundAndTriggerRefresh:
              function () {
                var fireRefreshButtonPressedOnSearchField = function (
                  oSearchField
                ) {
                ...
                return this.iSearchForValueWithActions([
                  new EnterText({ text: sSomethingThatCannotBeFound }),
        ...
        assertions: jQuery.extend(
          {
            ...
            theTableShouldHaveAllEntries: function () {
              var aAllEntities, iExpectedNumberOfItems;

              // retrieve all DocumentListSet to be able to check for the total amount
              this.waitFor(
                this.createAWaitForAnEntitySet({
              ...
              return this.waitFor({
                ...
                matchers: function (oTable) {
                  ...
                  iExpectedNumberOfItems = Math.min(
                    oTable.getGrowingThreshold(),
                    aAllEntities.length
                  );
                ...
                success: function (oTable) {
                  Opa5.assert.strictEqual(
                    ...
                    "The growing Table has " + iExpectedNumberOfItems + " items"
                  );
                },
                ...
                success: function (oTable) {
                  ...
                  this.waitFor({
                    ...
                    matchers: function (oPage) {
                      var sExpectedText = oPage
                        .getModel("i18n")
                        .getResourceBundle()
                        .getText("worklistTableTitleCount", [iObjectCount]);
                    ...
                    success: function () {
                      Opa5.assert.ok(
                        true,
                        "The Page has a title containing the number " +
                          iObjectCount
                      );
                    },
                    errorMessage:
                      "The Page's header does not container the number of items " +
                      iObjectCount,
                  });
                },
            ...
            theTableShouldHaveTheDoubleAmountOfInitialEntries: function () {
              ...
              return this.waitFor({
                ...
                success: function () {
                  Opa5.assert.ok(
                    true,
                    "The growing Table had the double amount: " +
                      iExpectedNumberOfItems +
                      " of entries"
                  );
                },
                errorMessage:
                  "Table does not have the double amount of entries.",
              });
            },
            ...
            iShouldSeeTheWorklistViewsBusyIndicator: function () {
              return this.waitFor({
                ...
                success: function (oPage) {
                  Opa5.assert.ok(
                    oPage.getParent().getBusy(),
                    "The worklist view is busy"
                  );
                },
              ...
              return this.waitFor({
                ...
                success: function (oTable) {
                  Opa5.assert.strictEqual(
                    ...
                    oTable
                      .getModel("i18n")
                      .getProperty("worklistNoDataWithSearchText"),
