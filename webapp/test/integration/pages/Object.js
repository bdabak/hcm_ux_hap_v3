        ...
        assertions: jQuery.extend(
          {
                  ...
                  this.waitFor({
                    ...
                    matchers: function (oPage) {
                      return (
                        ...
                        oPage.getBindingContext().getPath() === sBindingPath
                      );
                    },
                    success: function (oPage) {
                      Opa5.assert.strictEqual(
                        oPage.getBindingContext().getPath(),
                        sBindingPath,
                        "was on the remembered detail page"
                      );
                    },
                    errorMessage:
                      "Remembered object " + sBindingPath + " is not shown",
                  });
                },
              });
            },
            ...
            theObjectViewsBusyIndicatorDelayIsZero: function () {
              return this.waitFor({
                ...
                success: function (oPage) {
                  Opa5.assert.strictEqual(
                    oPage.getBusyIndicatorDelay(),
                    0,
                    "The object view's busy indicator delay is zero."
                  );
                },
                errorMessage:
                  "The object view's busy indicator delay is not zero.",
              });
            },
            ...
            theObjectViewsBusyIndicatorDelayIsRestored: function () {
              return this.waitFor({
                ...
                success: function () {
                  Opa5.assert.ok(
                    true,
                    "The object view's busy indicator delay default is restored."
                  );
                },
                errorMessage:
                  "The object view's busy indicator delay is still zero.",
              });
            },
            ...
            theShareTileButtonShouldContainTheRememberedObjectName:
              function () {
                return this.waitFor({
                  id: "shareTile",
                  viewName: sViewName,
                  ...
                  success: function () {
                    Opa5.assert.ok(
                      true,
                      "The Save as Tile button contains the object name"
                    );
                  },
                  errorMessage:
                    "The Save as Tile did not contain the object name",
                });
              },
          },
