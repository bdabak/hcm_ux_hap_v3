sap.ui.define(
  ["sap/ui/test/Opa5", "hcm/ux/hapv3/test/integration/pages/Common"],
        ...
        actions: {
          ...
          iChangeTheHashToTheRememberedItem: function () {
            return this.waitFor({
              success: function () {
                ...
                Opa5.getHashChanger().setHash("/DocumentListSet/" + sObjectId);
              },
            });
          },
          ...
          iRestartTheAppWithTheRememberedItem: function (oOptions) {
            ...
            return this.waitFor({
              success: function () {
                oOptions.hash =
                  "/DocumentListSet/" + encodeURIComponent(sObjectId);
