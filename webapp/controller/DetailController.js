...
sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend("hcm.ux.hapv3.controller.DetailController", {
      formatter: formatter,
      hasChanges: false,
      ...
      _onPatternMatched: function (oEvent) {
        ...
        var sMode = oEvent.getParameter("arguments").mode || "X";
        var oViewModel = this.getModel("formDetailsModel");
      ...
      _getDocumentDetail: function () {
        ...
        aFilters.push(
          new Filter(
            "Mode",
            FilterOperator.EQ,
            oViewModel.getProperty("/mode") === "D"
              ? ""
              : oViewModel.getProperty("/mode")
          )
        );
      ...
      _handleActionButtonPressed: function (oEvent) {
        ...
        switch (oButton.data("ButtonId")) {
          ...
          case "CANCEL":
            ...
            break;
          case "PRINT":
            this._handlePrintDocument(oButton);
            break;
          case "STAT_LOG":
