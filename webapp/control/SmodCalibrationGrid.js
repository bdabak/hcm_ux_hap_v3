sap.ui.define(
  ...
  function (
    ...
    "use strict";
    var E = Control.extend("hcm.ux.hapv3.control.SmodCalibrationGrid", {
      metadata: {
        properties: {
          gridTitle: {
            type: "string",
        ...
        aggregations: {
          blockList: {
            type: "hcm.ux.hapv3.control.SmodCalibrationGridBlock",
            multiple: true,
            singularName: "block",
          },
          filterBar: {
            type: "hcm.ux.hapv3.control.SmodCalibrationGridFilter",
            multiple: false,
          },
          graph: {
      ...
      init: function () {
        var libraryPath = jQuery.sap.getModulePath("hcm.ux.hapv3"); //get the server location of the ui library
